      ...
      <div className="container-custom">
        ...
        <div className="grid gap-6 md:grid-cols-2 xl:grid-cols-3 xl:gap-8">
          ...
          {testimonials.map((testimonial) => (
            <article
              key={testimonial.id}
              className="glass group relative flex h-full flex-col overflow-hidden rounded-[28px] border border-white/10 p-6 transition-all duration-500 hover:-translate-y-2 hover:border-white/20 hover:bg-white/[0.045] sm:p-8"
            >
